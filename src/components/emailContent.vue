    ...
    <div>
      <div class="flex items-center justify-between flex-1 mb-3 py-2 px-2">
        <!-- <div class="flex-1 w-auto "> -->
          <a @click="navigateToHome" href="#"
            class="flex text-gray-700 px-2 py-1 mr-5 space-x-0.5 border border-gray-300 rounded-lg shadow hover:bg-gray-200 transition duration-100"
            title="Back">
      ...
      <div class="flex p-2  justify-center">
        <div class=" w-1/4 flex items-center justify-center w-10 h-10 rounded-full bg-gray-500 text-white">
            <span class="text-xl font-bold">{{ fromInitial }}</span>
        </div>
        <div class="w-1/2">
          <div class="flex">
