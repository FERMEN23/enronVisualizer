<template>
    <div class="h-16 flex items-center justify-between">
        <div class="flex items-center">
            ...
            <!-- <button @click="modificarValor">Modificar Valor</button> -->
    <div class="flex items-left  max-w-md mx-auto bg-white rounded-lg " x-data="{ search: '' }">
        <div class="w-full py-2 border border-black-300 rounded-tl-lg rounded-bl-lg align-middle">
            <input v-model="search" type="search" class="w-full px-4 py-1 text-gray-800 rounded-full focus:outline-none "
        ...
        <div class="px-2 flex items-center space-x-4">
            <span class="text-sm text-gray-500">{{ (currentPage - 1) * pageSize +1 }}-{{ (currentPage ) * pageSize }} de {{ length }}</span>
